...
describe('Advanced reporting test', () => {
    ...
    it('Attaching labels to test and launch', async () => {
        ...
        logger.info("Example shows how to add labels using annotation for a specific launch");
    });
    ...
    it('Attaching artifact references to test and launch', async () => {
        ...
        // will be attached to the entire run
        currentLaunch.attachArtifactReference('Zebrunner WebdriverIO reporting agent', 'https://zebrunner.com/documentation/reporting/webdriverio/');
